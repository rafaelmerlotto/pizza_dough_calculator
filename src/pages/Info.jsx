...
export default function Info (){
  return (
    ...
    <Text style={styles.text}>With this pizza dough calculator app, you can create your own dough using a
    ...
    <Text style={styles.text}><MaterialCommunityIcons name="update" size={18} color="#29252c" /> Version: <Text style={{fontWeight:"bold"}}>1.0.1</Text></Text>
